...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        maxZoom: 28,
        minZoom: 1,
        extent: [97.354107, 12.813512, 108.281768, 18.968284],
        projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [100.039390, 12.907390, 102.503230, 18.775690],
            units: 'degrees'
        })
    })
});
...
map.getView().fit([97.354107, 12.813512, 108.281768, 18.968284], map.getSize());
